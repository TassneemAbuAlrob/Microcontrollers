...
# 6691 "C:/Program Files (x86)/Microchip/MPLABX/v5.35/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8\\pic\\include\\proc\\pic18f4620.h" 3
...
void initTimers01(void) {
    ...
    T0CONbits.T0PS1 = 1;
    T0CONbits.T0PS2 = 0;
    TMR0H = (unsigned char) ((3036 >> 8) & 0x00FF);
    TMR0L = (unsigned char) (3036 & 0x00FF);
    T1CONbits.TMR1CS = 1;
    T1CONbits.T1CKPS1 = 0;
    T1CONbits.T1CKPS0 = 0;
    TMR1H = 0;
